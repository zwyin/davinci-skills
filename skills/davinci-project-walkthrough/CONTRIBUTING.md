...
- `skills/davinci-project-walkthrough/SKILL.md` — Canonical skill definition (single source of truth)
...
- `skills/davinci-project-walkthrough/SKILL.md` — Skill logic, parameters, process
