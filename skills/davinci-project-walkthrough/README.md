...
[![CI](https://github.com/zwyin/davinci-skills-skill/actions/workflows/test.yml/badge.svg)](https://github.com/zwyin/davinci-skills-skill/actions/workflows/test.yml)
...
```bash
# 1. 添加 marketplace
/plugin marketplace add zwyin/davinci-skills-skill
...
```bash
git clone https://github.com/zwyin/davinci-skills-skill.git
...
| **Gemini CLI** | `gemini skills install https://github.com/zwyin/davinci-skills-skill.git --path skills/project-walkthrough` |
...
/project-walkthrough /path/to/project --depth deep --no-confirm    # Deep + 跳过确认门
/project-walkthrough /path/to/project --lang zh-pure               # Brief + general + 纯中文
/project-walkthrough /path/to/project --lang bilingual             # Brief + general + 中英对照
/project-walkthrough --version                                    # 显示版本号
```
