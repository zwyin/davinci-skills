...
[![CI](https://github.com/zwyin/davinci-skills/actions/workflows/test.yml/badge.svg)](https://github.com/zwyin/davinci-skills/actions/workflows/test.yml)
...
[← 返回 davinci-skills 合集](https://github.com/zwyin/davinci-skills#readme)
...
安装后直接在任意项目中使用 `/davinci-project-walkthrough` 命令。
...
claude --plugin-dir ./davinci-skills  # 保留完整目录结构，路径引用不会断裂
```
...
| 平台 | 安装方式 |
|------|---------|
| **Cursor** | 复制 `cursor/davinci-project-walkthrough.mdc` 到项目的 `.cursor/rules/` 目录 |
| **Windsurf** | 复制 `.windsurf/rules/davinci-project-walkthrough.md` 到项目的 `.windsurf/rules/` 目录，或全局复制到 `~/.codeium/windsurf/rules/` |
| **OpenCode** | 复制 `.opencode/skills/davinci-project-walkthrough/` 到项目的 `.opencode/skills/` 目录，或全局复制到 `~/.config/opencode/skills/` |
...
```
/davinci-project-walkthrough /path/to/project --depth deep --audience dev
```
...
/davinci-project-walkthrough --depth all                                  # All depths + general + zh (CWD)
/davinci-project-walkthrough /path/to/project --lang en                   # Brief + general + en
/davinci-project-walkthrough /path/to/project --depth deep --no-confirm    # Deep + 跳过确认门
/davinci-project-walkthrough /path/to/project --lang zh-pure               # Brief + general + 纯中文
/davinci-project-walkthrough /path/to/project --lang bilingual             # Brief + general + 中英对照
/davinci-project-walkthrough --version                                    # 显示版本号
```
...
> 详细解析规则见 `skills/davinci-project-walkthrough/SKILL.md` Usage 部分。
