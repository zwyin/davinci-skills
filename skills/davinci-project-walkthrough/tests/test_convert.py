...
SKILL_MD = ROOT / "skills" / "davinci-project-walkthrough/SKILL.md"
CURSOR_FILE = ROOT / "cursor" / "davinci-project-walkthrough.mdc"
WINDSURF_FILE = ROOT / ".windsurf" / "rules" / "davinci-project-walkthrough.md"
OPENCODE_FILE = ROOT / ".opencode" / "skills" / "davinci-project-walkthrough" / "SKILL.md"
...
class TestOpenCodeFile:
    ...
    def test_frontmatter_has_name(self):
        ...
        assert fm.get("name") == "davinci-project-walkthrough"
